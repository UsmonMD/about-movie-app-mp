...
class UpcomingBtnTab extends StatelessWidget {
  const UpcomingBtnTab({super.key});
          ...
          return Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) => Padding(
                ...
                child: MoviesCover(
                  image:
                      '${Api.imagePath}${state.upcoming.results?[index].posterPath}',
                  movieId: '${state.upcoming.results?[index].id}',
                ),
              ),
