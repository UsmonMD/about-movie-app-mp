...
class PopularBtnTab extends StatelessWidget {
  const PopularBtnTab({super.key});
          ...
          return Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) => Padding(
                ...
                child: MoviesCover(
                  image:
                      '${Api.imagePath}${state.popular.results?[index].posterPath}',
                  movieId: '${state.popular.results?[index].id}',
                ),
              ),
